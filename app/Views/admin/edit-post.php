            ...
            <div class="col-md-10 col-lg-8 col-xl-7">
                ...
                <div class="my-5">
                    ...
                    <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="post" action="<?= url_to('edit_post', $post['id']) ?>" enctype="multipart/form-data">
                        ...
                        <input autocomplete="off" type="hidden" value="<?= $post['image'] ?>" name="delete_image">
                        <div class="form-floating my-4">
                            <textarea class="form-control" id="message" name="content"  style="height: 12rem" data-sb-validations="required"><?= $post['content'] ?></textarea>
                        ...
                        <!-- has successfully submitted-->
                         <?php if (session()->getFlashdata('postSuccess')) : ?>
                            ...
                            <?php endif; ?>
                        <!-- Submit Button-->
                        <button class="btn btn-primary text-uppercase w-25" id="submitButton" name="submit" type="submit">edit post</button>
                    </form>
                </div>
            </div>
        </div>
